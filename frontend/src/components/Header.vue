    ...
    <div class="grid">
      <div class="sub-grid">
        ...
        <div style="padding-top: 19px;">
          <img src="../assets/logo.png" align="left" width="85"  margin="0" />
        </div>
        </router-link>
        <router-link class="font-icon" to="/">
          <p class="font-icon">文</p>
        </router-link>
        <router-link class="font-icon" to="/transforum">
          <p class="font-icon">译</p>
        </router-link>
        <router-link to="/whisper">
          <p class="font-icon">叨</p>
        </router-link>
      </div>
      <div>
        <h1> </h1>
